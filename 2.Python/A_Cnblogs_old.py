...
def getData(url):
    ...
    html = Posthtml(url)#B1_requests.Gethtml(url)
    #print(html)
...
def Posthtml(url):
  ...
  'Referer':'https://www.cnblogs.com/',
   'CategoryType':'SiteHome','ParentCategoryId':0,'CategoryId':808,'PageIndex':2,'TotalPostCount':4000,'ItemListActionName':'PostList'};
  #ParaGet = {'key':'value'};
...
for r in a:
    ...
    write2('./test.xls', '\r'.join( getData(r))+'\r')
